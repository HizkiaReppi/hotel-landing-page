  ...
  return (
    <>
      <div className="container mx-auto mt-40">
        <div className="location-map relative w-full h-[700px] rounded-2xl overflow-hidden">
        ...
        <div className="location-box flex gap-28 p-11 relative bottom-[280px] z-[401] bg-white mx-11 rounded-2xl">
          ...
          <div className="location-box-right w-1/2 flex items-end">
            <div className="flex just justify-between w-full bg-[#FAFAFA] rounded-[50px]">
              ...
              <Button addClass={'rounded-[50px] px-12'}>Contact</Button>
            </div>
          </div>
        </div>
      </div>
