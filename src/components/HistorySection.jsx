...
const HistorySection = () => {
    return (
        <>
            <div className="history-section md:container bg-[#f6fcf9] relative md:mx-auto mt-8">
                <div className="flex columns-2 max-md:columns-1 max-md:flex-wrap max-sm:flex-wrap">
                    ...
                    <div className="history-right pl-16 pt-[6%] max-2xl:pl-8 max-2xl:pt-12 max-sm:pt-2">
                        <h1 className="history-title leading-[80px] text-6xl font-semibold mt-3 max-md:text-3xl max-md:leading-[43px] max-2xl:text-[50px] max-sm:text-[30px]">
                        ...
                        <Button
                            addClass={
                                "mt-12 py-4 px-8 rounded-[36px]  max-2xl:mt-4 max-sm:mt-6 max-sm:w-26 max-sm:h-10 max-sm:text-[15px] max-sm:leading-[10px]"
                            }
                        >
                            Explore More
                        </Button>
